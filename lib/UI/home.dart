...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  @override
  void initState() {
    decisionProcessingBannerAd = BannerAd(
      adUnitId: AdHelper.decisionProcessingBannerAdUnitId,
      request: AdRequest(),
      size: AdSize.banner,
      listener: BannerAdListener(
        onAdLoaded: (_) {
          setState(() {
            isDecisionProcessingBannerAdReady = true;
          });
        },
        onAdFailedToLoad: (ad, err) {
          print('Failed to load a banner ad: ${err.message}');
          isDecisionProcessingBannerAdReady = false;
          ad.dispose();
        },
      ),
    );

    decisionProcessingBannerAd.load();
  }

  @override
  void dispose() {

    decisionProcessingBannerAd.dispose();
    super.dispose();
  }
  @override
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      height: SizeConfig.safeBlockVertical * 4.44,
                                    ),
                                    Stack(
                                      children: [
                                        Align(
                                        ...
                                        Container(
                                          width: SizeConfig.safeBlockHorizontal *
                                              68.4,
                                          height:
                                              SizeConfig.safeBlockVertical * 4.44,
                                          decoration: BoxDecoration(
                                            color: purpleColor,
                                            borderRadius:
                                    ...
                                    Container(
                                      width:
                                          SizeConfig.safeBlockHorizontal * 25.5,
                                      height: SizeConfig.safeBlockVertical * 4.44,
                                      decoration: BoxDecoration(
                                        color: whiteColor,
                                        borderRadius: BorderRadius.only(
                            ...
                            Container(
                              ...
                              height: SizeConfig.safeBlockVertical * 61,
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.only(
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(
                              0, SizeConfig.safeBlockVertical * 1.2, 0, SizeConfig.safeBlockVertical * 1.2),
                          child: CustomButton(
                            "Decide Your Fate",
                            onTap: items.length < 2
                                ...
                                : () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => DecisionProcessing(
                                              items[i],
                                              decisionProcessingBannerAd,
                                              isDecisionProcessingBannerAdReady)),
                                    );
                                  },
                          ),
                        )
